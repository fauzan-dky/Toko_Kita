...
@section('toko_kita')
	<div class="container mt-5 mb-5" >
		<div class="row">
			<h1 class="text-center">Daftar Produk Makanan</h1>
				...
				<div class="card mt-4 card-product" >
					...
					<div class="card-body">
						...
						@if (Auth()->user()->level=="Admin")
							...
							<!--Delete Button-->
							<a class="btn btn-primary btn-sm" href="{{url('/edit_product_food/'.$list->id)}}"><i class="fa fa-edit fa-lg"></i> Edit </a><!--Edit Button-->
							<br><br>
						@endif
