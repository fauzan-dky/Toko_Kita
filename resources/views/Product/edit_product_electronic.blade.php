...
@section('toko_kita')
	<div class="container">
		<div class="card bg-warning" style="padding: 20px; margin: 10px;">
			...
			<div class="card-body">
				<form action="{{url('/save_edited_product_electronic')}}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<a href="{{url('/list_electronic_product')}}" class="btn btn-primary">Kembali</a>
				</form>
			</div>
		</div>
	</div>
