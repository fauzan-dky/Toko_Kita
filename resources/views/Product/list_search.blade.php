...
@section('toko_kita')
	<div class="container mt-5 mb-5" >
		<div class="row">
			...
			<h5 class="text-center mt-4"><span>hasil pencarian dari "<b>{{ $namaProduct }}</b>"</span></h5>
				...
				<div class="card mt-4 card-product" >
					...
					<div class="card-body">
						...
						@if (Auth()->user()->level=="Admin")
							...
							<!--Delete Button-->
							<a class="btn btn-primary btn-sm" href="{{url('/edit_product_electronic/'.$list->id)}}"><i class="fa fa-edit fa-lg"></i> Edit </a><!--Edit Button-->
						@endif
						<br><br>
	...
	<script>
		function hapusProduk (id_produk) {
			...
			var my_url = "{{ url('/delete_electronic') }}";
			var formData = {
							'_token' : token,
							'id' : id_produk
							};
